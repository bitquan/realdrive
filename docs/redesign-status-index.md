...
- admin scope: first mobile-tightening redesign checkpoint is now in progress locally with shared shell/layout and core workflow cleanup
...
- [docs/admin-redesign-status.md](docs/admin-redesign-status.md) is now the active tracker for the first admin mobile-tightening checkpoint.
